...
foreach($results as $row){
	...
	echo "<td><a href='".base_url()."bug_control/edit_bug_logic/".$row['bug_id']."'><span class='icon gray' data-icon='7' style='display: inline-block;'></span>Edit</a>";
	echo " <a href='".base_url()."bug_control/delete_bug_logic/".$row['bug_id']."'><span class='icon gray' data-icon='m' style='display: inline-block;'>Delete</a>";
	echo "</tr>";
}
