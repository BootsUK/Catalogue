...
--
-- Host: localhost
-- Generation Time: Oct 10, 2012 at 02:17 PM
...
(NULL, 'web98-admin-4', 'components', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'components', 'title', 2, NULL, 'NO', 'varchar', 125, 125, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(125)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'components', 'description', 3, NULL, 'NO', 'varchar', 555, 555, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(555)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'components', 'view', 4, NULL, 'NO', 'varchar', 125, 125, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(125)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'components', 'technologies', 5, NULL, 'NO', 'varchar', 555, 555, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(555)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'components', 'status', 6, NULL, 'NO', 'varchar', 125, 125, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(125)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'components', 'date_added', 7, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'components', 'author', 8, NULL, 'NO', 'varchar', 75, 75, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(75)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'components', 'contributors', 9, NULL, 'NO', 'varchar', 555, 555, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(555)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'components', 'version', 10, NULL, 'NO', 'varchar', 5, 5, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(5)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'components', 'git_hub_link', 11, NULL, 'NO', 'varchar', 555, 555, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(555)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'layouts', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'layouts', 'title', 2, NULL, 'NO', 'varchar', 125, 125, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(125)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'layouts', 'description', 3, NULL, 'NO', 'varchar', 555, 555, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(555)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'layouts', 'view', 4, NULL, 'NO', 'varchar', 125, 125, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(125)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'layouts', 'technologies', 5, NULL, 'NO', 'varchar', 555, 555, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(555)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'layouts', 'status', 6, NULL, 'NO', 'varchar', 125, 125, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(125)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'layouts', 'template', 7, NULL, 'NO', 'varchar', 125, 125, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(125)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'layouts', 'date_added', 8, NULL, 'NO', 'varchar', 12, 12, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(12)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'layouts', 'author', 9, NULL, 'NO', 'varchar', 75, 75, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(75)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'layouts', 'contributors', 10, NULL, 'NO', 'varchar', 555, 555, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(555)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'layouts', 'version', 11, NULL, 'NO', 'varchar', 5, 5, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(5)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'temp_users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'temp_users', 'email', 2, NULL, 'NO', 'varchar', 125, 125, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(125)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'temp_users', 'password', 3, NULL, 'NO', 'varchar', 125, 125, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(125)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'temp_users', 'first_name', 4, NULL, 'NO', 'varchar', 55, 55, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(55)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'temp_users', 'last_name', 5, NULL, 'NO', 'varchar', 75, 75, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(75)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'temp_users', 'company', 6, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'temp_users', 'key', 7, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'templates', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'templates', 'title', 2, NULL, 'NO', 'varchar', 125, 125, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(125)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'templates', 'title_in_cms', 3, NULL, 'NO', 'varchar', 125, 125, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(125)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'templates', 'description', 4, NULL, 'NO', 'varchar', 555, 555, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(555)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'templates', 'width', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(4)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'users', 'first_name', 2, NULL, 'NO', 'varchar', 75, 75, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(75)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'users', 'last_name', 3, NULL, 'NO', 'varchar', 125, 125, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(125)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'users', 'email', 4, NULL, 'NO', 'varchar', 125, 125, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(125)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'users', 'password', 5, NULL, 'NO', 'varchar', 125, 125, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(125)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'users', 'company', 6, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update', ''),
(NULL, 'web98-admin-4', 'users', 'admin', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(1)', '', '', 'select,insert,update', '');
...
('ABORTED_CLIENTS', '154'),
('ABORTED_CONNECTS', '7684'),
('BINLOG_CACHE_DISK_USE', '0'),
('BINLOG_CACHE_USE', '0'),
('BYTES_RECEIVED', '3876377507'),
('BYTES_SENT', '1746434298590'),
('COM_ADMIN_COMMANDS', '155978'),
...
('COM_ALTER_SERVER', '0'),
('COM_ALTER_TABLE', '1580'),
('COM_ALTER_TABLESPACE', '0'),
('COM_ANALYZE', '5'),
('COM_BACKUP_TABLE', '0'),
('COM_BEGIN', '50824'),
('COM_BINLOG', '0'),
('COM_CALL_PROCEDURE', '87'),
('COM_CHANGE_DB', '585607'),
('COM_CHANGE_MASTER', '0'),
('COM_CHECK', '0'),
('COM_CHECKSUM', '23'),
('COM_COMMIT', '52470'),
('COM_CREATE_DB', '3092'),
('COM_CREATE_EVENT', '0'),
('COM_CREATE_FUNCTION', '11'),
('COM_CREATE_INDEX', '6'),
('COM_CREATE_PROCEDURE', '0'),
('COM_CREATE_SERVER', '0'),
('COM_CREATE_TABLE', '6098'),
...
('COM_DEALLOC_SQL', '893'),
('COM_DELETE', '147014'),
('COM_DELETE_MULTI', '115'),
('COM_DO', '0'),
('COM_DROP_DB', '2'),
('COM_DROP_EVENT', '0'),
('COM_DROP_FUNCTION', '11'),
('COM_DROP_INDEX', '0'),
...
('COM_HELP', '0'),
('COM_INSERT', '298545'),
('COM_INSERT_SELECT', '5084'),
('COM_INSTALL_PLUGIN', '0'),
('COM_KILL', '1'),
('COM_LOAD', '89'),
('COM_LOAD_MASTER_DATA', '0'),
('COM_LOAD_MASTER_TABLE', '0'),
('COM_LOCK_TABLES', '8697'),
('COM_OPTIMIZE', '295'),
('COM_PRELOAD_KEYS', '0'),
('COM_PREPARE_SQL', '893'),
('COM_PURGE', '0'),
('COM_PURGE_BEFORE_DATE', '0'),
('COM_RELEASE_SAVEPOINT', '146'),
('COM_RENAME_TABLE', '0'),
('COM_RENAME_USER', '0'),
('COM_REPAIR', '189'),
('COM_REPLACE', '12074'),
('COM_REPLACE_SELECT', '67'),
('COM_RESET', '0'),
('COM_RESTORE_TABLE', '0'),
('COM_REVOKE', '0'),
('COM_REVOKE_ALL', '0'),
...
('COM_SAVEPOINT', '146'),
('COM_SELECT', '17480922'),
('COM_SET_OPTION', '1566535'),
('COM_SHOW_AUTHORS', '0'),
('COM_SHOW_BINLOG_EVENTS', '0'),
('COM_SHOW_BINLOGS', '27'),
('COM_SHOW_CHARSETS', '11'),
('COM_SHOW_COLLATIONS', '21'),
('COM_SHOW_COLUMN_TYPES', '0'),
('COM_SHOW_CONTRIBUTORS', '0'),
('COM_SHOW_CREATE_DB', '4530'),
('COM_SHOW_CREATE_EVENT', '0'),
('COM_SHOW_CREATE_FUNC', '1'),
('COM_SHOW_CREATE_PROC', '5'),
('COM_SHOW_CREATE_TABLE', '160780'),
...
('COM_SHOW_EVENTS', '0'),
('COM_SHOW_ERRORS', '0'),
('COM_SHOW_FIELDS', '419323'),
('COM_SHOW_FUNCTION_STATUS', '4544'),
('COM_SHOW_GRANTS', '16'),
('COM_SHOW_KEYS', '887'),
...
('COM_SHOW_PROCEDURE_STATUS', '4544'),
('COM_SHOW_PROCESSLIST', '9721'),
('COM_SHOW_PROFILE', '0'),
('COM_SHOW_PROFILES', '0'),
...
('COM_SHOW_TABLE_STATUS', '161269'),
('COM_SHOW_TABLES', '57478'),
('COM_SHOW_TRIGGERS', '159809'),
('COM_SHOW_VARIABLES', '880'),
('COM_SHOW_WARNINGS', '1'),
('COM_SLAVE_START', '0'),
('COM_SLAVE_STOP', '0'),
('COM_STMT_CLOSE', '997'),
('COM_STMT_EXECUTE', '993'),
('COM_STMT_FETCH', '0'),
('COM_STMT_PREPARE', '999'),
('COM_STMT_REPREPARE', '0'),
('COM_STMT_RESET', '9'),
('COM_STMT_SEND_LONG_DATA', '0'),
('COM_TRUNCATE', '277'),
('COM_UNINSTALL_PLUGIN', '0'),
('COM_UNLOCK_TABLES', '9507'),
('COM_UPDATE', '494146'),
('COM_UPDATE_MULTI', '921'),
('COM_XA_COMMIT', '0'),
('COM_XA_END', '0'),
('COM_XA_PREPARE', '0'),
('COM_XA_RECOVER', '0'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '432381'),
('CREATED_TMP_DISK_TABLES', '1181900'),
('CREATED_TMP_FILES', '57623'),
('CREATED_TMP_TABLES', '2100458'),
('DELAYED_ERRORS', '0'),
('DELAYED_INSERT_THREADS', '3'),
('DELAYED_WRITES', '390'),
('FLUSH_COMMANDS', '1'),
('HANDLER_COMMIT', '3975682'),
('HANDLER_DELETE', '233695'),
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '3158359'),
('HANDLER_READ_KEY', '538556640'),
('HANDLER_READ_NEXT', '5058012184'),
('HANDLER_READ_PREV', '76325534'),
('HANDLER_READ_RND', '2126563665'),
('HANDLER_READ_RND_NEXT', '11985214027'),
('HANDLER_ROLLBACK', '874'),
('HANDLER_SAVEPOINT', '145'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '25661095'),
('HANDLER_WRITE', '652001631'),
('INNODB_BUFFER_POOL_PAGES_DATA', '7798'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '92'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '118358'),
('INNODB_BUFFER_POOL_PAGES_FREE', '1'),
('INNODB_BUFFER_POOL_PAGES_MISC', '393'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '10771'),
('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '4121'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '1952589847'),
('INNODB_BUFFER_POOL_READS', '494264'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1386242'),
('INNODB_DATA_FSYNCS', '164691'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '20615516160'),
('INNODB_DATA_READS', '569211'),
('INNODB_DATA_WRITES', '251188'),
('INNODB_DATA_WRITTEN', '4111281152'),
('INNODB_DBLWR_PAGES_WRITTEN', '118358'),
('INNODB_DBLWR_WRITES', '5470'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '333456'),
('INNODB_LOG_WRITES', '149926'),
('INNODB_OS_LOG_FSYNCS', '153755'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '230951936'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '5269'),
('INNODB_PAGES_READ', '1258138'),
('INNODB_PAGES_WRITTEN', '118358'),
('INNODB_ROW_LOCK_CURRENT_WAITS', '0'),
('INNODB_ROW_LOCK_TIME', '153'),
('INNODB_ROW_LOCK_TIME_AVG', '2'),
('INNODB_ROW_LOCK_TIME_MAX', '75'),
('INNODB_ROW_LOCK_WAITS', '73'),
('INNODB_ROWS_DELETED', '49926'),
('INNODB_ROWS_INSERTED', '68460'),
('INNODB_ROWS_READ', '767948766'),
('INNODB_ROWS_UPDATED', '79192'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '209827'),
('KEY_BLOCKS_USED', '65396'),
('KEY_READ_REQUESTS', '932237650'),
('KEY_READS', '12492910'),
('KEY_WRITE_REQUESTS', '8518723'),
('KEY_WRITES', '1843864'),
...
('OPEN_FILES', '949'),
('OPEN_STREAMS', '0'),
('OPEN_TABLE_DEFINITIONS', '576'),
('OPEN_TABLES', '600'),
('OPENED_FILES', '10655577'),
('OPENED_TABLE_DEFINITIONS', '1974233'),
('OPENED_TABLES', '2225693'),
...
('QUESTIONS', '21894341'),
('RPL_STATUS', 'NULL'),
('SELECT_FULL_JOIN', '147174'),
('SELECT_FULL_RANGE_JOIN', '7164'),
('SELECT_RANGE', '1764705'),
('SELECT_RANGE_CHECK', '26163'),
('SELECT_SCAN', '4310725'),
...
('SLOW_QUERIES', '8579'),
('SORT_MERGE_PASSES', '40090'),
('SORT_RANGE', '951218'),
('SORT_ROWS', '2168879003'),
('SORT_SCAN', '1563589'),
...
('SSL_VERIFY_MODE', '0'),
('SSL_VERSION', ''),
('TABLE_LOCKS_IMMEDIATE', '23524375'),
('TABLE_LOCKS_WAITED', '2423'),
...
('THREADS_RUNNING', '2'),
('UPTIME', '38644'),
('UPTIME_SINCE_FLUSH_STATUS', '38644');
...
('BASEDIR', '/'),
('PID_FILE', '/var/lib/mysql/web98.extendcp.co.uk.pid'),
...
('LOG_BIN', 'OFF'),
('GENERAL_LOG_FILE', '/var/lib/mysql/web98.log'),
...
('LOG_ERROR', '/var/lib/mysql/web98.extendcp.co.uk.err'),
('LOCAL_INFILE', 'ON'),
('REPORT_USER', ''),
('HAVE_RTREE_KEYS', 'YES'),
('LOG', 'OFF'),
...
(NULL, 'web98-admin-4', 'PRIMARY', NULL, 'web98-admin-4', 'components', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'web98-admin-4', 'PRIMARY', NULL, 'web98-admin-4', 'layouts', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'web98-admin-4', 'PRIMARY', NULL, 'web98-admin-4', 'temp_users', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'web98-admin-4', 'PRIMARY', NULL, 'web98-admin-4', 'templates', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'web98-admin-4', 'PRIMARY', NULL, 'web98-admin-4', 'users', 'id', 1, NULL, NULL, NULL, NULL);
...
(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-10-10 13:17:19', '2012-10-10 13:17:19', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-10-10 13:17:19', '2012-10-10 13:17:19', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-10-10 13:17:19', '2012-10-10 13:17:19', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-10-10 13:17:19', '2012-10-10 13:17:19', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-10-10 13:17:19', '2012-10-10 13:17:19', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-10-10 13:17:19', '2012-10-10 13:17:19', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-10-10 13:17:19', '2012-10-10 13:17:19', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-10-10 13:17:19', '2012-10-10 13:17:19', NULL, NULL, '', '', NULL),
(NULL, 'web98-admin-4', 'components', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2012-10-10 10:20:24', NULL, NULL, NULL, '', '', NULL),
(NULL, 'web98-admin-4', 'layouts', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2012-10-10 10:20:24', NULL, NULL, NULL, '', '', NULL),
(NULL, 'web98-admin-4', 'temp_users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 124, 264, 281474976710655, 2048, 140, '2012-10-10 12:37:45', '2012-10-10 13:11:08', NULL, NULL, '', '', NULL),
(NULL, 'web98-admin-4', 'templates', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 0, '2012-10-10 10:20:24', NULL, NULL, NULL, '', '', NULL),
(NULL, 'web98-admin-4', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 108, 108, 281474976710655, 2048, 0, '2012-10-10 12:38:08', '2012-10-10 13:11:08', NULL, NULL, '', '', NULL);
...
('binlog', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50157.0', NULL, NULL, 'MySQL AB', 'This is a pseudo storage engine to represent the binlog in a transaction', 'GPL'),
('partition', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50157.0', NULL, NULL, 'Mikael Ronstrom, MySQL AB', 'Partition Storage Engine Helper', 'GPL'),
('ARCHIVE', '3.0', 'ACTIVE', 'STORAGE ENGINE', '50157.0', NULL, NULL, 'Brian Aker, MySQL AB', 'Archive storage engine', 'GPL'),
('BLACKHOLE', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50157.0', NULL, NULL, 'MySQL AB', '/dev/null storage engine (anything you write to it disappears)', 'GPL'),
('CSV', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50157.0', NULL, NULL, 'Brian Aker, MySQL AB', 'CSV storage engine', 'GPL'),
('FEDERATED', '1.0', 'DISABLED', 'STORAGE ENGINE', '50157.0', NULL, NULL, 'Patrick Galbraith and Brian Aker, MySQL AB', 'Federated MySQL storage engine', 'GPL'),
('MEMORY', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50157.0', NULL, NULL, 'MySQL AB', 'Hash based, stored in memory, useful for temporary tables', 'GPL'),
('InnoDB', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50157.0', NULL, NULL, 'Innobase OY', 'Supports transactions, row-level locking, and foreign keys', 'GPL'),
('MyISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50157.0', NULL, NULL, 'MySQL AB', 'Default engine as of MySQL 3.23 with great performance', 'GPL'),
('MRG_MYISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50157.0', NULL, NULL, 'MySQL AB', 'Collection of identical MyISAM tables', 'GPL');
...
(432376, 'web98-admin-4', 'localhost', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
(NULL, 'web98-admin-4', 'latin1', 'latin1_swedish_ci', NULL);
...
('''web98-admin-4''@''%''', NULL, 'web98-admin-4', 'SELECT', 'YES'),
('''web98-admin-4''@''%''', NULL, 'web98-admin-4', 'INSERT', 'YES'),
('''web98-admin-4''@''%''', NULL, 'web98-admin-4', 'UPDATE', 'YES'),
('''web98-admin-4''@''%''', NULL, 'web98-admin-4', 'DELETE', 'YES'),
('''web98-admin-4''@''%''', NULL, 'web98-admin-4', 'CREATE', 'YES'),
('''web98-admin-4''@''%''', NULL, 'web98-admin-4', 'DROP', 'YES'),
('''web98-admin-4''@''%''', NULL, 'web98-admin-4', 'INDEX', 'YES'),
('''web98-admin-4''@''%''', NULL, 'web98-admin-4', 'ALTER', 'YES'),
('''web98-admin-4''@''%''', NULL, 'web98-admin-4', 'LOCK TABLES', 'YES'),
('''web98-admin-4''@''%''', NULL, 'web98-admin-4', 'EXECUTE', 'YES'),
('''web98-admin-4''@''%''', NULL, 'web98-admin-4', 'CREATE VIEW', 'YES'),
('''web98-admin-4''@''%''', NULL, 'web98-admin-4', 'SHOW VIEW', 'YES'),
('''web98-admin-4''@''%''', NULL, 'web98-admin-4', 'CREATE ROUTINE', 'YES'),
('''web98-admin-4''@''%''', NULL, 'web98-admin-4', 'ALTER ROUTINE', 'YES');
...
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '10771'),
('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '4121'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '1952616958'),
('INNODB_BUFFER_POOL_READS', '494273'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1386319'),
('INNODB_DATA_FSYNCS', '164702'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '20615663616'),
('INNODB_DATA_READS', '569220'),
('INNODB_DATA_WRITES', '251199'),
('INNODB_DATA_WRITTEN', '4111308288'),
('INNODB_DBLWR_PAGES_WRITTEN', '118358'),
('INNODB_DBLWR_WRITES', '5470'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '333502'),
('INNODB_LOG_WRITES', '149937'),
('INNODB_OS_LOG_FSYNCS', '153766'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '230979072'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '5269'),
('INNODB_PAGES_READ', '1258147'),
('INNODB_PAGES_WRITTEN', '118358'),
('INNODB_ROW_LOCK_CURRENT_WAITS', '0'),
('INNODB_ROW_LOCK_TIME', '153'),
('INNODB_ROW_LOCK_TIME_AVG', '2'),
('INNODB_ROW_LOCK_TIME_MAX', '75'),
('INNODB_ROW_LOCK_WAITS', '73'),
('INNODB_ROWS_DELETED', '49927'),
('INNODB_ROWS_INSERTED', '68463'),
('INNODB_ROWS_READ', '767983488'),
('INNODB_ROWS_UPDATED', '79200'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '209287'),
('KEY_BLOCKS_USED', '65396'),
('KEY_READ_REQUESTS', '932263727'),
('KEY_READS', '12493472'),
('KEY_WRITE_REQUESTS', '8519098'),
('KEY_WRITES', '1843905'),
...
('OPEN_FILES', '875'),
('OPEN_STREAMS', '0'),
('OPEN_TABLE_DEFINITIONS', '574'),
('OPEN_TABLES', '600'),
('OPENED_FILES', '10656353'),
...
('SSL_VERIFY_MODE', '0'),
('SSL_VERSION', ''),
('TABLE_LOCKS_IMMEDIATE', '23525662'),
('TABLE_LOCKS_WAITED', '2423'),
('TC_LOG_MAX_PAGES_USED', '0'),
('TC_LOG_PAGE_SIZE', '0'),
('TC_LOG_PAGE_WAITS', '0'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '38646'),
('UPTIME_SINCE_FLUSH_STATUS', '38646');
...
(NULL, 'web98-admin-4', 'components', 0, 'web98-admin-4', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'web98-admin-4', 'layouts', 0, 'web98-admin-4', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'web98-admin-4', 'temp_users', 0, 'web98-admin-4', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'web98-admin-4', 'templates', 0, 'web98-admin-4', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'web98-admin-4', 'users', 0, 'web98-admin-4', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', '');
...
(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-10-10 13:17:20', '2012-10-10 13:17:20', NULL, 'utf8_general_ci', NULL, 'max_rows=4560', ''),
...
(NULL, 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-10-10 13:17:20', '2012-10-10 13:17:20', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
...
(NULL, 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-10-10 13:17:20', '2012-10-10 13:17:20', NULL, 'utf8_general_ci', NULL, 'max_rows=5612', ''),
(NULL, 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-10-10 13:17:20', '2012-10-10 13:17:20', NULL, 'utf8_general_ci', NULL, 'max_rows=13025', ''),
(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-10-10 13:17:20', '2012-10-10 13:17:20', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
...
(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-10-10 13:17:20', '2012-10-10 13:17:20', NULL, 'utf8_general_ci', NULL, 'max_rows=588', ''),
...
(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-10-10 13:17:20', '2012-10-10 13:17:20', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
...
(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-10-10 13:17:20', '2012-10-10 13:17:20', NULL, 'utf8_general_ci', NULL, 'max_rows=6932', ''),
(NULL, 'web98-admin-4', 'components', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 290455552, 1, '2012-10-10 10:20:24', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'web98-admin-4', 'layouts', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 290455552, 1, '2012-10-10 10:20:24', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'web98-admin-4', 'temp_users', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 124, 264, 281474976710655, 2048, 140, 4, '2012-10-10 12:37:45', '2012-10-10 13:11:08', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'web98-admin-4', 'templates', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 290455552, 2, '2012-10-10 10:20:24', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'web98-admin-4', 'users', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 108, 108, 281474976710655, 2048, 0, 3, '2012-10-10 12:38:08', '2012-10-10 13:11:08', NULL, 'latin1_swedish_ci', NULL, '', '');
...
(NULL, 'web98-admin-4', 'PRIMARY', 'web98-admin-4', 'components', 'PRIMARY KEY'),
(NULL, 'web98-admin-4', 'PRIMARY', 'web98-admin-4', 'layouts', 'PRIMARY KEY'),
(NULL, 'web98-admin-4', 'PRIMARY', 'web98-admin-4', 'temp_users', 'PRIMARY KEY'),
(NULL, 'web98-admin-4', 'PRIMARY', 'web98-admin-4', 'templates', 'PRIMARY KEY'),
(NULL, 'web98-admin-4', 'PRIMARY', 'web98-admin-4', 'users', 'PRIMARY KEY');
...
--
CREATE DATABASE `web98-admin-4` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `web98-admin-4`;
...
(2, 'Ewan', 'Valentine', 'ewan.valentine@boots.co.uk', '34fc977bfdd8b24fc9255f4e8b13915f', 'Boots', 0);
